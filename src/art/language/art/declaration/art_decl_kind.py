...
class ArtDeclKind(Flag):
    ...
    ENUM_MEMBER_DECL         =  9 | COMPOSITE_MASK  # noqa  enumeration

    SUB_DECL                 = 10 | SUBTYPE_MASK    # noqa  subtype: byte = 0-255, ascii7 = 0-127
    SLICE_DECL               = 11 | SUBTYPE_MASK    # noqa  slice: [1:5:1]
    SPAN_DECL                = 12 | SUBTYPE_MASK    # noqa  span: 1-5
    RANGE_DECL               = 13 | SUBTYPE_MASK    # noqa  range: [1-5], (1-5], [1-5), (1-5), closed, half-open, open

    FUNCTION_DECL            = 14 | CALLABLE_MASK   # noqa  fn
    ANONYMOUS_FUNCTION_DECL  = 15 | CALLABLE_MASK   # noqa  anonymous function
    PROCEDURE_DECL           = 16 | CALLABLE_MASK   # noqa  proc
    ANONYMOUS_PROCEDURE_DECL = 17 | CALLABLE_MASK   # noqa  anonymous procedure
    LAMBDA_DECL              = 18 | CALLABLE_MASK   # noqa  lambda
    CLOSURE_DECL             = 19 | CALLABLE_MASK   # noqa  closure

    TYPE_PARAMETER           = 20 | GENERIC_MASK    # noqa
    TYPE_ARGUMENT            = 21 | GENERIC_MASK    # noqa
